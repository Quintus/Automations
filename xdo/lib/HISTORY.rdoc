...
* Deprecated the use of a Hash for specifying window search parameters in favor of a rest argument. Affected methods are: XWindow.search, XWindow.exists?, XWindow.wait_for_window, XWindow.wait_for_close. 
